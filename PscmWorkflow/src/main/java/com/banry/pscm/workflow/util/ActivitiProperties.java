...
public class ActivitiProperties {
	...
	private String processDefinitionLocationPrefix = "classpath:/deployments/";
	...
	public boolean isCreateDiagramOnDeploy() {
		return createDiagramOnDeploy;
	}

	public void setCreateDiagramOnDeploy(boolean createDiagramOnDeploy) {
